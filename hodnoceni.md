...
3. **Kvalita a srozumitelnost dokumentace (0 až 2 body)** - Popis projektu v `README.md` či `projekt.md`.
...
Student pracoval průběžně po večerech na svém vlastním projektu. Odevzdal 3 commity s drobnými 12hodinovými rozestupy, popisy commitů byly obstojné. Vytvořil logiku složitějšího algoritmu hry a AI uznala práci jako "Těžkou" (Stupeň 4).
...
**Získáno z AI: 16/20**
Získali jsme víc než požadované minimum 6 bodů, takže se nám odemkly i bonusy za podmínky! Základ máme: (16 x 2 = **32**)
